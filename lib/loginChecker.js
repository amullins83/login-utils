(function() {
  ...
  var bcryptUtils = require("./util/bcryptUtils"),
    ...
    SocialMediaUserSchema = require("./model/SocialMediaUserSchema"),
    PasswordResetTokenSchema = require("./model/PasswordResetTokenSchema"),
    mongoose = require("mongoose"),
    moment = require("moment"),
    crypto = require('crypto'),
    connectString;

  if(process.env.MONGODB_CONNECT && !process.env.TEST_MODE)
    connectString = process.env.MONGODB_CONNECT;
  else
    connectString = "mongodb://127.0.0.1/login-utils-test";
